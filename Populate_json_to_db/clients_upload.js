...
async function uploadJSONToCollection(clients, jsonFile) {
  ...
  for (const item of data) {
    ...
    await db.collection(clients).doc(item.id).set(item, { merge: true });
  }

  console.log("Upload complete!");
}

uploadJSONToCollection("clients", "fixed_clients_converted.json")
  .catch(console.error);
