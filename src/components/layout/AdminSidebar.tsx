...
export function AdminSidebar() {
  ...
  const { pendingCount, inquiryCount, newOrChargeSlipNumbers, pendingChargeSlipCount, projectFormCount } = useApprovalNotifications();
              ...
              <div className="space-y-1">
                {section.items.map(({ href, label, icon: Icon }) => (
                  ...
                  >
                    ...
                    {href === "/admin/projects" && projectFormCount > 0 && (
                      <span className={cn(
                        "min-w-[20px] h-5 flex items-center justify-center rounded-full text-[10px] font-bold px-1.5",
                        isActive(href)
                          ? "bg-white text-[#166FB5]"
                        ...
                        {projectFormCount > 9 ? "9+" : projectFormCount}
                      </span>
                    )}
                    ...
                    {isTabOpen(href.replace("/admin/", "")) && !isActive(href) && href !== "/admin/member-approvals" && href !== "/admin/inquiry" && href !== "/admin/projects" && (href !== "/admin/charge-slips" || pendingChargeSlipCount === 0) && (
