...
const formatBioinformaticsDetailsHtml = (details: Record<string, any> | undefined): string => {
  ...
  return `
    ...
    <tr>
      ...
      <td style="padding: 4px 0;">${fileFormats || "—"}${details.dataOtherFormat ? `; Others: ${details.dataOtherFormat}` : ""}</td>
    </tr>
    <tr>
      <td style="padding: 4px 0; color: #64748b;">Specify file size for each sample:</td>
      <td style="padding: 4px 0;">${details.dataFileSizePerSample || "—"}</td>
    </tr>
    <tr>
      <td style="padding: 4px 0; color: #64748b;">Preferred mode of file transfer:</td>
      <td style="padding: 4px 0;">${details.dataTransferMode || "—"}</td>
    </tr>` : ""}
    <tr>
...
const formatBioinformaticsDetailsText = (details: Record<string, any> | undefined): string => {
  ...
  return [
    ...
    details.dataProvideOwnData
      ? `File format: ${fileFormats || "—"}${details.dataOtherFormat ? `; Others: ${details.dataOtherFormat}` : ""}`
      : "",
    details.dataProvideOwnData ? `Specify file size for each sample: ${details.dataFileSizePerSample || "—"}` : "",
    details.dataProvideOwnData ? `Preferred mode of file transfer: ${details.dataTransferMode || "—"}` : "",
