...
export default function QuotationBuilder() {
  ...
  const referenceNumber = "VMENF-Q-2025-198-001";
  ...
  return (
    <div className="p-6 flex gap-6">
      ...
      <div className="w-80 shrink-0 sticky top-6 h-fit border p-4 rounded-md shadow-sm bg-white">
        ...
        {isInternal && <p className="text-sm">Discount (12%): ₱{discount.toFixed(2)}</p>}
        <p className="text-base font-semibold text-primary">Total: ₱{total.toFixed(2)}</p>
