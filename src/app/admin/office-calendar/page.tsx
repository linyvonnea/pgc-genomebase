...
const EVENT_TYPE_ICONS: Record<OfficeEventType, React.ReactNode> = {
  ...
  birthday: <PartyPopper className="h-3 w-3" />,
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Manage holidays, activities, closures, and birthdays. Birthdays stay
            internal to the office calendar and do not trigger automated client
            chat notices.
          </p>
        </div>
        {/* Legend */}
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                placeholder={
                  form.type === "birthday"
                    ? "Optional internal note for this birthday event..."
              ...
              {form.type === "birthday" && (
                <p className="text-xs text-slate-400">
                  Birthday events stay on the office calendar only and will not
                  appear in client automated notices.
                </p>
              )}
            </div>
